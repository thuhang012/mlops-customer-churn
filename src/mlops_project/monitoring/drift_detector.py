...
class DriftDetector:
    ...
    def detect_prediction_drift(
        self,
        production_predictions: pd.Series,
        historical_predictions: Optional[pd.Series] = None
    ) -> Tuple[bool, Dict]:
        """
...
class RetrainingTrigger:
    ...
    def trigger_retrain_workflow(
        ...
        url = (
            ...
            f"/actions/workflows/ct.yml/dispatches"
        )
    ...
    try:
        ...
        if feature_drift_detected:
            ...
            trigger_result = retrain_trigger.trigger_retrain_workflow(
                ...
                additional_metadata=drift_report
            )
        ...
        if 'actual_labels' in production_data.columns:
            ...
            if degradation_detected:
                ...
                trigger_result = retrain_trigger.trigger_retrain_workflow(
                    ...
                    additional_metadata=degradation_report
                )
